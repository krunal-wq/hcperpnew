...
MODULE_SUB_PERMS = {
    ...
    'material': [
        ...
        ('tab_types',      'Tab: Item Types'),
        ('type_add',       'Types: Add'),
        ('type_edit',      'Types: Edit'),
        ('type_delete',    'Types: Delete'),
        ('tab_groups',     'Tab: Item Groups'),
        ('group_add',      'Groups: Add'),
        ('group_edit',     'Groups: Edit'),
        ('group_delete',   'Groups: Delete'),
        ('tab_categories', 'Tab: Categories'),
        ('trash_items',    'Items: Trash'),
        ('trash_types',    'Types: Trash'),
        ('trash_groups',   'Groups: Trash'),
        ('trash_cats',     'Categories: Trash'),
        ('cat_add',        'Categories: Add'),
        ('cat_edit',       'Categories: Edit'),
        ('cat_delete',     'Categories: Delete'),
        # Item Type permissions
        ('type_rm',  'Type: Raw Material (RM)'),
        ('type_pm',  'Type: Packing Material (PM)'),
        ('type_fg',  'Type: Finished Goods (FG)'),
        ('type_sfg', 'Type: Semi-Finished (SFG)'),
        ('type_con', 'Type: Consumable (CON)'),
        ('type_tg',  'Type: Trading Goods (TG)'),
    ],
    'raw_material_sample': [
